...
$(document).ready(function() {
		...
		function changeRentalFind() {
				...
				$('#projectContent').text('Rental Find was created in order to help streamline the process of finding investment properties, helping to tune out the noise during the search process, and help individuals find cashflow positive properties.');
		...
		function changeWeShallGift() {
				...
				$('#techStack').text('Ruby on Rails, Devise, Stripe Connect, Amazon Product Advertising API, Twilio & SendGrid');		
		}
